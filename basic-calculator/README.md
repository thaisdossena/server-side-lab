...
### Erros conhecidos:
Caso o Sonar não esteja identificando seus testes, mesmo que na IDE eles estejam cobrindo os cenários corretamente, verifique se o nome da classe segue o padrão mencionado acima e se a estrutura de pastas está de acordo com o que foi visto nas aulas.
